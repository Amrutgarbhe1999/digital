...
function Navbar() {
  ...
  <div class="container-fluid">
    <Link to='/' style={{color:'#fff', fontWeight:'500'}} class="navbar-brand" href="#">Utakarsha Murtadak</Link>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <Link to= '/' class="nav-link active" aria-current="page" href="#" style={{color:'#fff'}}>Home</Link>
        </li>
        {/* <li class="nav-item">
          <Link class="nav-link active" aria-current="page" href="#" style={{color:'#fff'}}>Services</Link>
        </li> */}
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><Link to='/digital-marketing' class="dropdown-item" href="#">Digital Marketing</Link></li>
            <li><Link class="dropdown-item" href="#">Graphics Desiging</Link></li>
